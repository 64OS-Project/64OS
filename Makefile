...
SRCS_C  := kernel/main.c boot/mb2p/mb2p_fnc.c boot/mb2p/mb2p_parse.c libk/string.c libk/stckprt.c drivers/fb/fbbase.c drivers/fb/fbprim.c drivers/fb/fbtextrender.c kernel/driver.c kernel/panic.c drivers/acpi/acpifnc.c drivers/acpi/acpipwr.c drivers/apic/lapic.c drivers/apic/ioapic.c kernel/time/bcd2utime.c kernel/time/clock.c kernel/time/delay.c kernel/time/rdcmos.c kernel/time/rtc.c kernel/time/timer.c kernel/interrupts/idt.c drivers/ps2kbd/ps2kbd.c kernel/mm/pmm.c kernel/mm/heap.c kernel/paging.c kernel/terminal.c kernel/cmd.c drivers/pci/pci.c drivers/disk/ide.c drivers/disk/blockdev.c drivers/disk/ahci.c libk/vsnprintf.c fs/vfs.c fs/fat32.c fs/exfat.c fs/devfs/devfs.c fs/devfs/std.c fs/devfs/blk.c kernel/tss.c kernel/sched.c kernel/findroot.c drivers/pci/hda.c kernel/biosdev.c drivers/disk/cdrom.c kernel/partition.c kernel/fileio.c kernel/cmd/builtin.c kernel/cmd/disk.c kernel/cmd/filesystem.c kernel/cmd/part.c kernel/cmd/root.c fs/procfs.c kernel/smp.c kernel/findcpus.c kernel/exp/pageexp.c kernel/exp/df.c kernel/exp/mc.c kernel/exp/ud.c crypto/random.c crypto/hash/md5.c crypto/hash/sha1.c crypto/hash/sha256.c crypto/cipher/chacha20.c crypto/selftest.c kernel/cmd/process.c kernel/net/arp.c kernel/net/ethernet.c kernel/net/icmp.c kernel/net/ipv4.c kernel/net/ipv6.c kernel/net/net.c kernel/net/tcp.c kernel/net/udp.c kernel/net/dhcp.c drivers/net/rtl8139.c drivers/acpi/aml.c drivers/usb/usb_core.c drivers/usb/ehci.c kernel/findfw.c kernel/errlist.c drivers/usb/xhci.c drivers/usb/hid_core.c drivers/usb/hid_keyboard.c
